...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#050505] p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-cyber-pink/20 blur-[100px] rounded-full" />
      <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-cyber-purple/20 blur-[100px] rounded-full" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2 text-sm">Join ZOOBO and get 100 free coins.</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                required
                className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-12 pr-4 text-white focus:outline-none focus:border-cyber-pink transition-colors"
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full btn-secondary py-4 rounded-xl font-bold flex items-center justify-center gap-2 mt-6"
          >
